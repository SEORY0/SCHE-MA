...
# Repo root: where config/, skills/, data/ live. Overridable via SCHEMATA_ROOT for
...
PKG_ROOT = Path(os.environ.get("SCHEMATA_ROOT") or Path(__file__).resolve().parents[3])
