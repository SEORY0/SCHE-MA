...
# This script lives at legacy/deploy/, so the repo root is three parents up.
sys.path.insert(0, str(Path(__file__).resolve().parent.parent.parent / "src"))

from schemata.legacy.a2a.agent import run as brain_run  # noqa: E402
from schemata.legacy.intake import A2ATaskSource  # noqa: E402
