...
# Examples
- Winning strategies observed: {'seed-sweep': 2, 'hint-literal': 1, 'construct': 1}
- Format families observed: {'unknown': 2, 'pcap': 1, 'pdf': 1}
# Citations
- Distilled from 4 train-set solves of this crash class.
